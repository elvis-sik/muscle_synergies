...
* Fork the ``muscle_synergies`` repo into your account.

* Obtain the source by cloning it onto your development machine.

  .. code-block:: console

      $ git clone git@github.com:your_name_here/muscle_synergies.git
      $ cd muscle_synergies
...
* Create and activate a Python virtual environment for local development. This
  ...
  .. note::
      ...
      (muscle_synergies) is used to indicate when the commands
...
* Develop fix or enhancement:
  ...
  * The change should be style compliant. Perform style check.
    ...
    .. code-block:: console
        ...
        (muscle_synergies) $ make check-style
