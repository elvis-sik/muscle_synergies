...
# help:
# help: Muscle Synergies Makefile help
# help:
...
venv:
	@rm -Rf venv
	@python3 -m venv venv --prompt muscle_synergies
...
.PHONY: check-types
check-types:
	@cd src; mypy -p muscle_synergies --ignore-missing-imports
...
.PHONY: dist-test
dist-test: dist
	@cd dist && ../tests/test-dist.bash ./muscle_synergies-*-py3-none-any.whl
