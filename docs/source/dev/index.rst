...
The Muscle Synergies project implements a regression
...
not broken existing functionality. The Muscle Synergies
...
.. code-block:: console
    ...
    (muscle_synergies) $ make sort-imports
...
.. code-block:: console
    ...
    (muscle_synergies) $ make check-static-analysis
...
.. code-block:: console
    ...
    (muscle_synergies) $ make check-lint
...
.. code-block:: console
    ...
    (muscle_synergies) $ make check-types
...
.. code-block:: console
    ...
    (muscle_synergies) $ make check-docs
...
.. code-block:: console
    ...
    (muscle_synergies) $ make serve-docs
...
- Create and push a repo tag to Github. As a convention use the package
  ...
  - This will trigger Github to create a release at:
    ...
    ::
        ...
        https://github.com/{username}/muscle_synergies/releases/{tag}
...
- Test the release distribution. This involves creating a virtual environment,
  ...
  .. code-block:: console
      ...
      (muscle_synergies) $ make dist-test

- Upload the release to PyPI using

  .. code-block:: console

      (muscle_synergies) $ make dist-upload

  The package should now be available at https://pypi.org/project/muscle_synergies/
